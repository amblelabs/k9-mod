package dev.amble.core.screenhandlers;
...
public class K9CellScreenHandler extends ScreenHandler {
    ...
    public static K9CellScreenHandler createDefault(int syncId, PlayerInventory playerInventory) {
        return new K9CellScreenHandler(K9ScreenHandlers.K9_CELL_HANDLER, syncId, playerInventory);
    }
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            if(itemStack2.getItem() != K9Items.K9_LITHIUM_CELL) return itemStack;
    ...
    public boolean canInsertIntoSlot(ItemStack stack, Slot slot) {
        if(stack.getItem() == K9Items.K9_LITHIUM_CELL) {
